...
const GroupLetters = ({getData, groupid, groupData}) => {
  ...
  const commentLetter = async (e, letterid, id,   comment) => {
    ...
    try {
      const response = await axios.post(
        `https://group-media-n7igozkfp-joshs-projects-9174c388.vercel.app/comment-group-letter`,
        {
          letterId: letterid,
          groupid: id,
          comment: comment,
  ...
  const likeLetter = async (letter_id) => {
    ...
    try {
      const response = await axios.post(
        "https://group-media-n7igozkfp-joshs-projects-9174c388.vercel.app/like-group-letter",
        {
          letterId: letter_id,
          groupid: groupid,
        },
  ...
  async function deleteLetter(id) {
    ...
    try {
      const response = await axios.post(
        `https://group-media-n7igozkfp-joshs-projects-9174c388.vercel.app/delete-group-letter`,
        {
          id: id,
          groupid: groupid
        },
  ...
  async function editLetter() {
    ...
    if (
      ...
      try {
        const response = await axios.post(
          "https://group-media-n7igozkfp-joshs-projects-9174c388.vercel.app/edit-group-letter",
          {
