...
const GroupType = () => {
  ...
  async function getGroups() {
    ...
    try {
      const response = await axios.get(
        `https://group-media-n7igozkfp-joshs-projects-9174c388.vercel.app/groups?category=${grouptype}`,
        {
          headers: {
  ...
  async function createGroup(e) {
    ...
    try {
      const response = await axios.post(
        "https://group-media-n7igozkfp-joshs-projects-9174c388.vercel.app/create-group",
        {
  ...
  async function joinGroup(id) {
    try {
      const response = await axios.post(
        "https://group-media-n7igozkfp-joshs-projects-9174c388.vercel.app/join-group",
        {
          groupid: id,
        },
        {
  ...
  async function requestGroup(id) {
    try {
      const response = await axios.post(
        "https://group-media-n7igozkfp-joshs-projects-9174c388.vercel.app/request-group",
        {
          groupid: id,
        },
        {
