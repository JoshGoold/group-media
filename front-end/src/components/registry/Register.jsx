...
const Register = () => {
  ...
  useEffect(()=>{
    async function pingCheck(){
      const response = await fetch('https://group-media-n7igozkfp-joshs-projects-9174c388.vercel.app/ping')
  ...
  const handleRegister = async (e) => {
    ...
    try {
      const response = await axios.post(`https://group-media-n7igozkfp-joshs-projects-9174c388.vercel.app/register`, {
