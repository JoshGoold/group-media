...
const Letter = (props) => {
  ...
  const commentLetter = async (e, id, username, comment) => {
    ...
    try {
      const response = await axios.post(
        `https://group-media-n7igozkfp-joshs-projects-9174c388.vercel.app/comment-letter`,
        {
          letterId: id,
  ...
  const likeLetter = async (letter_id, username) => {
    ...
    try {
      const response = await axios.post(
        "https://group-media-n7igozkfp-joshs-projects-9174c388.vercel.app/like-letter",
        {
          letterId: letter_id,
          profileUsername: username,
        },
  ...
  async function deleteLetter(id) {
    ...
    try {
      const response = await axios.post(
        `https://group-media-n7igozkfp-joshs-projects-9174c388.vercel.app/delete-letter`,
        {
          id: id,
        },
        {
  ...
  async function editLetter() {
    ...
    if (
      ...
      try {
        const response = await axios.post(
          "https://group-media-n7igozkfp-joshs-projects-9174c388.vercel.app/edit-letter",
          {
