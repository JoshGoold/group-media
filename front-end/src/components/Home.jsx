...
async function getData(){
  const getToken = localStorage.getItem('token');
    try {
        const response = await axios.get("https://group-media-4tf1q58sf-joshs-projects-9174c388.vercel.app/home-feed",{
          headers: {
...
async function getRecommended(){
  const getToken = localStorage.getItem('token');
  try {
    const response = await axios.get("https://group-media-4tf1q58sf-joshs-projects-9174c388.vercel.app/recomendation", {
      headers: {
      'Authorization': `Bearer ${getToken}`, // Include the token in the Authorization header
      'Content-Type': 'application/json'
    }})
